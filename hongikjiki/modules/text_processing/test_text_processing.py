...
class DocumentLoaderTest(unittest.TestCase):
    ...
    def test_load_text_file(self):
        ...
        self.assertIn("content", doc_data or {})
        self.assertIn("metadata", doc_data or {})
        self.assertEqual(doc_data["metadata"]["filename"], "test_document.txt")  # type: ignore[reportOptionalSubscript]
        self.assertTrue("이것은 테스트 문서입니다." in doc_data["content"])  # type: ignore[reportOptionalSubscript]
